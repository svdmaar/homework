...
1. Copy/paste your `for` loop and modify it so only numbers smaller than `53` and bigger than `57` are printed.
1. Copy/paste your `for` loop and modify it so only numbers between `52` and `55` are printed.
